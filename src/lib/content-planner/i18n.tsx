...
const TRANSLATIONS: Record<Lang, Dict> = {
  th: {
    ...
    "reminder.title_manager": "👋 มีงานรอคอมเมนต์จากผู้จัดการครับ!",
    "reminder.subtitle_creator": "งานนี้ได้รับคะแนนด่วนพิเศษ แนะนำให้รีบดำเนินงานให้เสร็จเพื่อเป้าหมายของสัปดาห์นี้ครับ",
    "reminder.subtitle_manager": "งานนี้ถูกตั้งสถานะเป็นรอคอมเมนต์ รบกวนเปิดรายละเอียดเพื่อตรวจงาน เขียนฟีดแบ็ก หรืออนุมัติงานชิ้นนี้ครับ",
  ...
  en: {
    ...
    "reminder.title_manager": "👋 A task is waiting for manager feedback!",
    "reminder.subtitle_creator": "This task is prioritized based on deadline and effort level. We recommend finishing this first.",
    "reminder.subtitle_manager": "This task is marked as awaiting feedback. Please open the details to review, comment, or approve it.",
